...
import { colorChange, getCopyRight } from '@/api/api.js';
  ...
  async onLaunch (option) {
    ...
    uni.getSystemInfo({
      success: function (res) {
        ...
        // if (res.windowWidth > 420 && !window.top.isPC && !/iOS|Android/i.test(res.system)) {
          // window.location.pathname = '/static/html/h5.html';
        // }
      }
    });
    // #endif
...
@import "static/ymfont/ymfont.css";
