	...
	<view class="productDetail" :style="colorStyle">
		<view class="headerBody" v-show="val.type=='video'">
			...
			<block v-if="playUrl!=''&& playUrl!=null">
				<div id="mse" class="video-player"></div>
			</block>
			<!-- #endif -->
			<!-- #ifdef MP || APP-PLUS -->
			<block v-if="playUrl!=''&& playUrl!=null">
		...
		<detail :val="val" type="video"></detail>
		<ymRight />
		<buyMenu :val="val" type="video" @onChangeFun="onChangeFun"></buyMenu>
	</view>
</template>
